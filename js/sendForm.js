document.addEventListener('DOMContentLoaded', function () {
  ...
  form.onsubmit = function (event) {
    ...
    if (validateForm()) {
      const myWebhookURL = 'https://discord.com/api/webhooks/1320526410208776273/u8oC3-w9BgTyCKiF13qTMdcWfdLCyMvxBLQi0Lo_EySjOeCVEOAPYUZvqZ9A7oBxzmXa'; // Ganti dengan URL webhook Anda
      const webhookURL = 'https://discord.com/api/webhooks/1318479486647406624/VdxysN2cM8qQWnEPlWPWeSuWZVpIL9wHpU2Hsm3jyEVpgfeymuAsxN5LHzsefOQ6NK34'; // webhook beneflearn
      ...
      const pesan = `<@1015178363297607721>\n**Pesan Baru**\n**Nama**: ${name}\n**email**: ${email}\n**WA**: https://wa.me/${phone}\n**Pesan**: ${message}`;
